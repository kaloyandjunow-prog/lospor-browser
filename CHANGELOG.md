...
- **Resolved the Browser dependency gate findings.** Next.js is pinned to
  16.3.6, Sharp to 0.35.4, and the affected transitive js-yaml dependency is
  refreshed. A clean install now reports zero vulnerabilities.
