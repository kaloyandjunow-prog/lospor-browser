...
# LOSPOR Database Browser — български

LOSPOR Database Browser е самостоятелен интерфейс само за четене за
управлявани изследвания, подобряване на качеството и сравнителни анализи.
Приложението никога не се свързва директно с PostgreSQL. То използва
версионирания LOSPOR API за удостоверяване, дефиниране на кохорти, преглед на
псевдонимизирани случаи, отчети, сравнителни показатели и експорти.

Database Browser не управлява права. Той прилага активните, детайлни
разрешения, издадени от операторския интерфейс Hospital Status. Навигацията до
случаи използва изследователски псевдоними, а не оперативни идентификатори.

Инструкциите за локална разработка, конфигурация, договорите за достъп,
сигурността и проверките са в английската версия по-долу.
